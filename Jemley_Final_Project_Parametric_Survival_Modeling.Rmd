...
\begin{tcolorbox}[width=\textwidth, colback={yellow}]
In the results you can note the similarity between these statistics and those from the  Wald statistics table for the full model. Had been very collinear with the kept/retained variables these similarities would not be the case.
\end{tcolorbox}
