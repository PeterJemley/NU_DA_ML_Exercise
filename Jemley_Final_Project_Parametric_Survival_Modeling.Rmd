...
Final Project, DA 5030 Data Mining and Machine Learning, Peter Jemley
...
# Hierarchical Cluster Analysis — Showing Patterns in an Missing Data
\begin{tcolorbox}[width=\textwidth, colback={yellow}]
...
\begin{tcolorbox}[width=\textwidth, colback={yellow}]
Next I began building the accelerated failure time parametric survival model. A big part of building this model is getting the subject matter input about which of the variables should be used as predictors and another big part is how to assign degrees of freedom to those variables. \\
...
# This formula maps the full model's coefficients onto the approximate 
# model coefficients.
v <- w %*% V %*% t(w)
```
