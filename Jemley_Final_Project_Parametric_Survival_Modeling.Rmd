...
```{r model_summary, fig.height = 4, fig.width = 4}
# 1
# 1a
ggplot(
...
\begin{tcolorbox}[width=\textwidth]
1. This returns the variance-covariance matrix of the main parameters of a fitted model object — in this case the full model, f_2.\\
2. This creates the design of the full model.\\
3. This creates the design of the simplified approxmiate model.\\
